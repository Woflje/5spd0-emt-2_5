...
lifetime=s:solverstart
result=s:1
treepath=s:Farfields\farfield (f=15) [pw]\farfield (f=15) [pw]
files=s:farfield (f=15) [pw].sig
xlabel=s:Theta / Degree
ylabel=s:V/m
title=s:Bistatic Scattering E-Field(r=1e+06m) Abs (Phi=90)
